...
public class TwitchClient {
    private static final String TOKEN = "Bearer h0jsyhpps4q3xd5evhn15xbw7zq1in";
    private static final String CLIENT_ID = "dxjuhqplffqdde1jp4xp7558b2qaqe";
    ...
    private String searchTwitch(String url) throws TwitchException {
        ...
        /*Define the response handler to parse and return
            HTTP response body returned from Twitch*/
        ...
        try {
            /*Define the HTTP request, TOKEN and CLIENT_ID are used
            for user authentication on Twitch backend*/
    ...
    /*Convert JSON format data returned from
    Twitch to an Arraylist of Game objects*/
